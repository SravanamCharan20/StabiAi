...
export function evaluateEmployeeModel(options = {}) {
  ...
  for (const row of rows) {
    ...
    const marketContext = {
      ...
      role_demand_index: toNumber(row.role_demand_index, 0),
      department_resilience_index: toNumber(row.department_resilience_index, 0),
      tech_stack_trend_score: toNumber(row.tech_stack_trend_score, 0),
